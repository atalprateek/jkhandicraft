...
defined('MAP_KEY')             OR define('MAP_KEY',""); //Google Map API Key
defined('RAZOR_KEY_ID')        OR define('RAZOR_KEY_ID',""); //Razorpay API Key
defined('RAZOR_SECRET')        OR define('RAZOR_SECRET',""); //Razorpay Secret
